...
df_vendas["ticket medio"] = df_vendas["vendas"] / df_vendas["clientes"]
...
df_vendas.loc[:, ["filial", "mes", "ticket medio", "meta batida"]]
# RESOLUCAO: complete aqui
...
df_vendas.groupby("mes")["vendas"].mean()
# c) Descubra a filial com maior total de vendas
df_vendas.groupby("filial")["vendas"].max().sort_values()
# RESOLUCAO: complete aqui
